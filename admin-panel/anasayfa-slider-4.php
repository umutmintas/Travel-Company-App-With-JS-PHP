...
<main>
    <div class="container-fluid px-4">
        <h1 class="mb-2 mt-4">Ana Sayfa  Banner 4</h1>
        <ol class="breadcrumb mb-5 ">
            ...
            <li class="breadcrumb-item active">Banner 4</li>
        </ol>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <table id="datatablesSimple">
                    ...
                    <tbody>
                    <tr hidden="hidden">
                        <td><?= $sonuc["Banner_4_Baslik_1"] ?></td>
                        <td><?= $sonuc["Banner_4_Baslik_2"] ?></td>

                        <td>
                            <img style="border-radius: 25px" width="300px" height="200px" src="../assets/images/upload/<?=$sonuc['Banner_4_images']?>" alt=""><br>
                        ...
                        <td class="text-center">
                            <?php if ($_SESSION["yetki"] == "1") { ?>
                                ...
                                <a href="anasayfa-slider-4-Guncelle.php?id=<?= $sonuc["id"] ?>)">
